...
```
   ...
   - Connect to `banjo.rit.edu` with an FTP client - instructions are here: [How to post to RIT's *banjo* web server](../notes/posting-to-banjo.md), create a `230` folder and place it in your `www` folder.
